...
let ApiService = class ApiService {
    ...
    getStones(page = 1) {
        ...
        return this.http
            .get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].authUrl}/stonus/v1/stones`, options)
    ...
    getStoneContent(id) {
        return this.http
            .get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].authUrl}/stonus/v1/stones/${id}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((stone) => {
            if (stone.photo) {
                stone.photo = stone.photo.sizes["medium"];
            }
            return stone;
    ...
    getUsers(page = 1) {
        ...
        return this.http
            .get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].authUrl}/stonus/v1/users`, options)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((res) => {
            let data = res["body"];
    ...
    getUserContent(id) {
        return this.http
            .get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].authUrl}/stonus/v1/users/${id}`)
    ...
    login(username, password) {
        return this.http
            .post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].authUrl}/jwt-auth/v1/token`, { username, password })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])((data) => {
            console.log("got token: ", data);
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(this.storage.set(JWT_KEY, data));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])((data) => {
            this.user.next(data);
        }));
    ...
    signUp(username, email, password) {
        ...
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].stonusUrl}/users/register`, postData);
    }
    resetPassword(usernameOrEmail) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].authUrl}/wp/v2/users/lostpassword`, {
    ...
    getPrivatePosts() {
        return this.http
            .get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl}/posts?_embed&status=private`)
...
module.exports = __webpack_require__(/*! D:\MAMP\htdocs\gitkraken\Stonus\src\main.ts */"./src/main.ts");
