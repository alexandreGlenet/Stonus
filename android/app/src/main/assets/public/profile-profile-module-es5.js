...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
  ...
  function srcAppTabsProfileProfileRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        /*! import() | profile-lists-profile-lists-module */
        "profile-lists-profile-lists-module").then(__webpack_require__.bind(null,
        /*! ./profile-lists/profile-lists.module */
        "./src/app/tabs/profile/profile-lists/profile-lists.module.ts")).then(function (m) {
          return m.ProfileListsPageModule;
        });
      }
    }];
  ...
  function srcAppTabsProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/services/api.service.ts"); //import { antPath } from "leaflet-ant-path";


    var Share = _capacitor_core__WEBPACK_IMPORTED_MODULE_5__["Plugins"].Share;

    var ProfilePage = /*#__PURE__*/function () {
      function ProfilePage(route, api, alertCtrl) {
